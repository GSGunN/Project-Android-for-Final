...
class MyRecyclerAdapter (context: Context,fragment : FragmentManager ,val dataSource: JSONArray) : RecyclerView.Adapter<MyRecyclerAdapter.Holder>() {
...
//        holder.priceTextView.setText( dataSource.getJSONObject(position).getString("price").toString() )
        ...
        holder.layout.setOnClickListener{
            ...
            val detail = detail().newInstance(dataSource.getJSONObject(position).getString("image").toString() ,holder.titleTextView.text.toString(),dataSource.getJSONObject(position).getString("description").toString())
            ...
            val friendlyMessage = FriendlyMessage(holder.titleTextView.text.toString());
